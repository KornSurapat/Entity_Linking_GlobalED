...
def create_dataloader(
    ...
    for document in documents:
        ...
        for mention in document.mentions:
            ...
            tokens += tokenizer.tokenize(document.text[cur : mention.start])
            # mention_tokens = tokenizer.tokenize(" ".join(document.words[mention.start : mention.end]))
            mention_tokens = tokenizer.tokenize(document.text[mention.start : mention.end])
        ...
        tokens += tokenizer.tokenize(document.text[cur:])
